...
// Fonction "Roll Dice" pour lancer le dé.
function rollDice() {
	let i = getRandomIntInclusive(1, 6);
	return i;
}
// Fonction "startNewGame" pour démarrer une nouvelle partie (remise des scores à zéro)
...
// Fonction "getRollDice" pour lancer le dé, afficher les points rouges du dé et tester si le résultat vaut 1
...
// Fonction "savePointsToGlobal" pour additionner le score du ROUND au score GLOBAL
